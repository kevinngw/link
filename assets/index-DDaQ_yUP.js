...
`;const w=document.querySelector("#board"),Oe=document.querySelector("#screen-kicker"),Pe=document.querySelector("#screen-title"),St=document.querySelector("#system-bar"),Pt=[...document.querySelectorAll(".tab-button")],qt=document.querySelector("#theme-toggle"),R=document.querySelector("#status-pill"),qe=document.querySelector("#current-time"),Y=document.querySelector("#updated-at"),h=document.querySelector("#station-dialog"),Be=document.querySelector("#dialog-title"),wt=document.querySelector("#dialog-status-pill"),_e=document.querySelector("#dialog-updated-at"),G=document.querySelector("#dialog-display"),Bt=[...document.querySelectorAll("[data-dialog-direction]")],x=document.querySelector("#station-alerts-container"),$t=document.querySelector("#arrivals-nb-pinned"),M=document.querySelector("#arrivals-nb"),Lt=document.querySelector("#arrivals-sb-pinned"),E=document.querySelector("#arrivals-sb"),L=document.querySelector("#train-dialog"),Ue=document.querySelector("#train-dialog-title"),He=document.querySelector("#train-dialog-subtitle"),Fe=document.querySelector("#train-dialog-line"),Tt=document.querySelector("#train-dialog-status"),Ve=document.querySelector("#train-dialog-close"),T=document.querySelector("#alert-dialog"),We=document.querySelector("#alert-dialog-title"),je=document.querySelector("#alert-dialog-subtitle"),Ye=document.querySelector("#alert-dialog-lines"),It=document.querySelector("#alert-dialog-body"),Dt=document.querySelector("#alert-dialog-link"),Ge=document.querySelector("#alert-dialog-close");G.addEventListener("click",()=>wa());Ve.addEventListener("click",()=>lt());Ge.addEventListener("click",()=>ct());Bt.forEach(t=>{t.addEventListener("click",()=>{s.dialogDisplayDirection=t.dataset.dialogDirection,s.dialogDisplayDirection==="auto"&&(s.dialogDisplayAutoPhase="nb"),it()})});h.addEventListener("click",t=>{t.target===h&&ae()});L.addEventListener("click",t=>{t.target===L&&lt()});T.addEventListener("click",t=>{t.target===T&&ct()});h.addEventListener("close",()=>{nt(),st(),at(),et(!1),s.isSyncingFromUrl||te()});Pt.forEach(t=>{t.addEventListener("click",()=>{s.activeTab=t.dataset.tab,b()})});qt.addEventListener("click",()=>{_t(s.theme==="dark"?"light":"dark"),b()});function J(){return O[s.activeSystemId]??O[D]}function Ke(){return s.systemsById.get(s.activeSystemId)?.agencyId??O[D].agencyId}function ze(){return`${Nt}/vehicles-for-agency/${Ke()}.json?key=${Z}`}function S(){return J().vehicleLabel??"Vehicle"}function Xe(t){return/bus$/i.test(t)?`${t}es`:`${t}s`}function v(){return J().vehicleLabelPlural??Xe(S())}function P(t){return t.replace("Station","").replace("Univ of Washington","UW").replace("Int'l","Intl").trim()}function Ze(){const t=window.localStorage.getItem(Ot);return t==="light"||t==="dark"?t:"dark"}function _t(t){s.theme=t,document.documentElement.dataset.theme=t,window.localStorage.setItem(Ot,t)}function At(){const t=window.visualViewport?.width??Number.POSITIVE_INFINITY,e=window.innerWidth||Number.POSITIVE_INFINITY,a=document.documentElement?.clientWidth||Number.POSITIVE_INFINITY,i=Math.min(e,t,a);s.compactLayout=i<=Me}function q(){const a=window.getComputedStyle(w).gridTemplateColumns.split(" ").map(i=>i.trim()).filter(Boolean).length<=1;a!==s.compactLayout&&(s.compactLayout=a,b())}function N(t){return t.toLowerCase().replace(/['.]/g,"").replace(/&/g,"and").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function F(t,e,a){return Math.max(e,Math.min(t,a))}function Je(t){if(!t)return"Waiting for snapshot";const e=Math.max(0,Math.round((Date.now()-new Date(t).getTime())/1e3));return e<10?"Updated now":e<60?`Updated ${e}s ago`:`Updated ${Math.round(e/60)}m ago`}function Qe(){return new Intl.DateTimeFormat("en-US",{timeZone:"America/Los_Angeles",hour:"numeric",minute:"2-digit"}).format(new Date)}function I(t){if(t<=0)return"Arriving";const e=Math.floor(t/60),a=t%60;return e>0?`${e}m ${a}s`:`${a}s`}function ta(){return new Intl.DateTimeFormat("en-CA",{timeZone:"America/Los_Angeles",year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date)}function xt(t){if(!t)return"";const[e="0",a="0"]=String(t).split(":"),i=Number(e),n=Number(a),o=(i%24+24)%24,r=o>=12?"PM":"AM";return`${o%12||12}:${String(n).padStart(2,"0")} ${r}`}function Ut(t){const e=ta(),a=t.serviceSpansByDate?.[e];return a?`Today ${xt(a.start)} - ${xt(a.end)}`:"Today service hours unavailable"}function Ht(t){return String(t||"SERVICE ALERT").replaceAll("_"," ").toLowerCase().replace(/\b\w/g,e=>e.toUpperCase())}function Ft(t){return String(t||"INFO").replaceAll("_"," ").toLowerCase().replace(/\b\w/g,e=>e.toUpperCase())}function C(t){return s.alerts.filter(e=>e.lineIds.includes(t))}function Vt(t,e){const a=C(e.id);if(!a.length)return[];const i=new Set(tt(t,e));return i.add(t.id),a.filter(n=>n.stopIds.length>0&&n.stopIds.some(o=>i.has(o)))}function ea(t){const e=new Set,a=[];for(const{station:i,line:n}of Qt(t))for(const o of Vt(i,n))e.has(o.id)||(e.add(o.id),a.push(o));return a}function Wt(t,e){return t.length?`
  ...
  `}function Et(t,e,a,i){if(!e.length)return`
      <div class="flow-lane">
  ...
  `}function ya(t,e,a,i,n){const o=a.length+i.length;if(!o)return"";const{nbGaps:r,sbGaps:l}=K(a,i),d=[...a,...i],u=fa(d),m=[...r,...l].length?Math.max(...r,...l):null,c=ga(a,i),p=Zt(t,a,i,n),f=new Set(n.flatMap(g=>g.stopIds??[])).size;return`
    <div class="line-insights">
      ...
      <div class="headway-health-grid">
        ${Mt("Direction ▲",r,a.length)}
        ${Mt("Direction ▼",l,i.length)}
      </div>
      ${ha(u,o)}
      <div class="flow-grid">
        ${Et("Direction ▲ Flow",a,e,t.color)}
        ${Et("Direction ▼ Flow",i,e,t.color)}
      </div>
  ...
  `}function Jt(t,e=!1){const a=Date.now(),i=o=>{const r=o.arrivalTime,l=Math.floor((r-a)/1e3),d=I(l),u=ne(o.arrivalTime,o.scheduleDeviation??0),m=ot(u);let c="";if(o.distanceFromStop>0){const p=o.distanceFromStop>=1e3?`${(o.distanceFromStop/1e3).toFixed(1)}km`:`${Math.round(o.distanceFromStop)}m`,f=o.numberOfStopsAway===1?"1 stop away":`${o.numberOfStopsAway} stops away`;c=` • ${p} • ${f}`}return`
    ...
    `};if(e){$t.innerHTML="",Lt.innerHTML="",M.innerHTML='<div class="arrival-item muted">Loading arrivals...</div>',E.innerHTML='<div class="arrival-item muted">Loading arrivals...</div>',X();return}const n=(o,r,l)=>{if(!o.length){r.innerHTML="",l.innerHTML=`<div class="arrival-item muted">No upcoming ${v().toLowerCase()}</div>`;return}const d=s.dialogDisplayMode?o.slice(0,2):[],u=s.dialogDisplayMode?o.slice(2):o;r.innerHTML=d.map(i).join(""),l.innerHTML=u.length?u.map(i).join(""):s.dialogDisplayMode?`<div class="arrival-item muted">No additional ${v().toLowerCase()}</div>`:""};n(t.nb,$t,M),n(t.sb,Lt,E),X()}function tt(t,e){const a=new Set(e.stationAliases?.[t.id]??[]);a.add(t.id);const i=new Set;for(const o of a){const r=o.startsWith(`${e.agencyId}_`)?o:`${e.agencyId}_${o}`;i.add(r)}const n=t.id.replace(/-T\d+$/,"");return i.add(n.startsWith(`${e.agencyId}_`)?n:`${e.agencyId}_${n}`),[...i]}function Qt(t){const e=s.lines.map(a=>{const i=a.stops.find(n=>n.id===t.id);return i?{line:a,station:i}:null}).filter(Boolean);return e.length>0?e:s.lines.map(a=>{const i=a.stops.find(n=>n.name===t.name);return i?{line:a,station:i}:null}).filter(Boolean)}function ba(t){if(!t)return null;const e=t.trim().toLowerCase();for(const a of s.lines)for(const i of a.stops){const n=new Set([i.id,`${a.agencyId}_${i.id}`,i.name,P(i.name),N(i.name),N(P(i.name))]);for(const o of a.stationAliases?.[i.id]??[])n.add(o),n.add(`${a.agencyId}_${o}`),n.add(N(o));if([...n].some(o=>String(o).toLowerCase()===e))return i}return null}function Sa(t){const e=new URL(window.location.href);e.searchParams.set("station",N(t.name)),window.history.pushState({},"",e)}function te(){const t=new URL(window.location.href);t.searchParams.has("station")&&(t.searchParams.delete("station"),window.history.pushState({},"",t))}function Ct(t){const e=new URL(window.location.href);t===D?e.searchParams.delete("system"):e.searchParams.set("system",t),window.history.pushState({},"",e)}function ee(){const e=new URL(window.location.href).searchParams.get("system");return e&&s.systemsById.has(e)?e:D}function et(t){s.dialogDisplayMode=t,h.classList.toggle("is-display-mode",t),G.textContent=t?"Exit":"Board",G.setAttribute("aria-label",t?"Exit display mode":"Toggle display mode"),s.dialogDisplayDirection="both",s.dialogDisplayAutoPhase="nb",it(),h.open&&s.currentDialogStation&&rt(s.currentDialogStation).catch(console.error),X()}function wa(){et(!s.dialogDisplayMode)}function at(){s.dialogDisplayDirectionTimer&&(window.clearInterval(s.dialogDisplayDirectionTimer),s.dialogDisplayDirectionTimer=0)}function it(){at();const t=s.dialogDisplayDirection,e=t==="auto"?s.dialogDisplayAutoPhase:t;Bt.forEach(a=>{a.classList.toggle("is-active",a.dataset.dialogDirection===t)}),h.classList.toggle("show-nb-only",s.dialogDisplayMode&&e==="nb"),h.classList.toggle("show-sb-only",s.dialogDisplayMode&&e==="sb"),s.dialogDisplayMode&&t==="auto"&&(s.dialogDisplayDirectionTimer=window.setInterval(()=>{s.dialogDisplayAutoPhase=s.dialogDisplayAutoPhase==="nb"?"sb":"nb",it()},Re))}function nt(){s.dialogRefreshTimer&&(window.clearTimeout(s.dialogRefreshTimer),s.dialogRefreshTimer=0)}function st(){s.dialogDisplayTimer&&(window.clearInterval(s.dialogDisplayTimer),s.dialogDisplayTimer=0)}function W(t,e){const a=[...t.querySelectorAll(".arrival-item:not(.muted)")];if(t.style.transform="translateY(0)",!s.dialogDisplayMode||a.length<=3)return;const i=Number.parseFloat(window.getComputedStyle(t).rowGap||"0")||0,n=a[0].getBoundingClientRect().height+i,o=Math.max(0,a.length-3),r=Math.min(s.dialogDisplayIndexes[e],o);t.style.transform=`translateY(-${r*n}px)`}function X(){st(),s.dialogDisplayIndexes={nb:0,sb:0},W(M,"nb"),W(E,"sb"),s.dialogDisplayMode&&(s.dialogDisplayTimer=window.setInterval(()=>{for(const[t,e]of[["nb",M],["sb",E]]){const a=[...e.querySelectorAll(".arrival-item:not(.muted)")];if(a.length<=3)continue;const i=Math.max(0,a.length-3);s.dialogDisplayIndexes[t]=s.dialogDisplayIndexes[t]>=i?0:s.dialogDisplayIndexes[t]+1,W(e,t)}},ke))}function $a(){if(!h.open)return;h.querySelectorAll(".arrival-item[data-arrival-time]").forEach(e=>{const a=Number(e.dataset.arrivalTime),i=Number(e.dataset.scheduleDeviation||0),n=e.querySelector(".arrival-countdown"),o=e.querySelector(".arrival-status");if(!n||!o)return;n.textContent=I(Math.floor((a-Date.now())/1e3));const r=ne(a,i),l=ot(r);o.textContent=r,o.className=`arrival-status arrival-status-${l}`})}function La(){if(nt(),!s.currentDialogStation)return;const t=()=>{s.dialogRefreshTimer=window.setTimeout(async()=>{!h.open||!s.currentDialogStation||(await rt(s.currentDialogStation).catch(console.error),t())},Ce)};t()}function ae(){s.currentDialogStationId="",s.currentDialogStation=null,h.open?h.close():(nt(),st(),at(),et(!1),te())}async function kt(){const t=ee();t!==s.activeSystemId&&await ue(t,{updateUrl:!1,preserveDialog:!1});const e=new URL(window.location.href).searchParams.get("station"),a=ba(e);s.isSyncingFromUrl=!0;try{if(!a){s.currentDialogStationId="",h.open&&h.close();return}if(s.activeTab="map",b(),s.currentDialogStationId===a.id&&h.open)return;await re(a,!1)}finally{s.isSyncingFromUrl=!1}}function Ta(t,e){const a=e.directionLookup?.[t.tripId??""];if(a==="1")return"nb";if(a==="0")return"sb";const i=t.tripHeadsign??"",n=i.toLowerCase();return e.nbTerminusPrefix&&n.startsWith(e.nbTerminusPrefix)?"nb":e.sbTerminusPrefix&&n.startsWith(e.sbTerminusPrefix)?"sb":/Lynnwood|Downtown Redmond/i.test(i)?"nb":/Federal Way|South Bellevue/i.test(i)?"sb":""}function ie(t){return t.routeKey??`${t.agencyId}_${t.id}`}function Ia(t){const e=t.tripHeadsign?.trim();return e?P(e.replace(/^to\s+/i,"")):"Terminal"}function ne(t,e){return Math.floor((t-Date.now())/1e3)<=90?"ARR":e>=120?"DELAY":"ON TIME"}function ot(t){return t==="DELAY"?"delay":t==="ARR"?"arr":"ok"}async function Da(t){const e=`${Nt}/arrivals-and-departures-for-stop/${t}.json?key=${Z}&minutesAfter=120`,a=await jt(e,"Arrivals");if(a.code!==200)throw new Error(a.text||`Arrivals request failed for ${t}`);return a.data?.entry?.arrivalsAndDepartures??[]}async function se(t){const e=[...new Set(t)],a=[],i=[];for(let n=0;n<e.length;n+=H){const o=e.slice(n,n+H),r=await Promise.allSettled(o.map(l=>Da(l)));a.push(...r),bt>0&&n+H<e.length&&await Q(bt)}for(const n of a)n.status==="fulfilled"&&i.push(...n.value);return i}function Aa(t,e){const a=Date.now(),i=new Set,n={nb:[],sb:[]};for(const o of t){if(o.routeId!==ie(e))continue;const r=o.predictedArrivalTime||o.scheduledArrivalTime;if(!r||r<=a)continue;const l=Ta(o,e);if(!l)continue;const d=`${o.tripId}:${o.stopId}:${r}`;i.has(d)||(i.add(d),n[l].push({vehicleId:(o.vehicleId||"").replace(/^\d+_/,"")||"--",arrivalTime:r,destination:Ia(o),scheduleDeviation:o.scheduleDeviation??0,tripId:o.tripId,lineColor:e.color,lineName:e.name,lineToken:e.name[0],distanceFromStop:o.distanceFromStop??0,numberOfStopsAway:o.numberOfStopsAway??0}))}return n.nb.sort((o,r)=>o.arrivalTime-r.arrivalTime),n.sb.sort((o,r)=>o.arrivalTime-r.arrivalTime),n.nb=n.nb.slice(0,4),n.sb=n.sb.slice(0,4),n}async function xa(t,e,a=null){const i=`${s.activeSystemId}:${e.id}:${t.id}`,n=s.arrivalsCache.get(i);if(n&&Date.now()-n.fetchedAt<De)return n.value;const o=tt(t,e),r=a??await se(o),l=Aa(r,e);return s.arrivalsCache.set(i,{fetchedAt:Date.now(),value:l}),l}function Ma(t){const e={nb:[],sb:[]};for(const a of t)e.nb.push(...a.nb),e.sb.push(...a.sb);return e.nb.sort((a,i)=>a.arrivalTime-i.arrivalTime),e.sb.sort((a,i)=>a.arrivalTime-i.arrivalTime),e}function oe(t){const e=ea(t);if(!e.length){x.innerHTML="",x.hidden=!0;return}x.hidden=!1,x.innerHTML=`
  ...
  `}function Ca(){const t=_().sort((r,l)=>r.minutePosition-l.minutePosition),e=S(),a=v(),i=a.toLowerCase();return t.length?(s.compactLayout?s.lines.filter(r=>r.id===s.activeLineId):s.lines).map(r=>{const l=t.filter(p=>p.lineId===r.id),d=C(r.id),u=l.filter(p=>p.directionSymbol==="▲"),m=l.filter(p=>p.directionSymbol==="▼"),c=(p,f)=>`
    ...
    ${a.map(({line:i,layout:n,vehicles:o,nb:r,sb:l,lineAlerts:d})=>{const u=ya(i,n,r,l,d);return`
        <article class="panel-card panel-card-wide">
          <header class="panel-header">
            <div class="line-title">
              ...
              <div>
                <h2>${i.name}</h2>
                <p>${o.length} live ${o.length===1?S().toLowerCase():v().toLowerCase()} · ${Ut(i)}</p>
              </div>
            </div>
          </header>
      ...
      `}).join("")}
  `}function Ra(){document.querySelectorAll("[data-system-switch]").forEach(e=>{e.addEventListener("click",async()=>{await ue(e.dataset.systemSwitch,{updateUrl:!0,preserveDialog:!1})})})}function j(){document.querySelectorAll("[data-line-switch]").forEach(e=>{e.addEventListener("click",()=>{s.activeLineId=e.dataset.lineSwitch,b()})})}function lt(){s.currentTrainId="",L.open&&L.close()}function ct(){T.open&&T.close()}function le(t){const e=C(t.id);We.textContent=`${t.name} Alerts`,je.textContent=`${e.length} active alert${e.length===1?"":"s"}`,Ye.textContent=t.name,It.textContent="",It.innerHTML=e.length?e.map(a=>`
  ...
  `,L.open||L.showModal()}function Oa(){document.querySelectorAll("[data-train-id]").forEach(e=>{e.addEventListener("click",()=>{const a=e.dataset.trainId,i=_().find(n=>n.id===a);i&&(s.currentTrainId=a,Na(i))})})}function Pa(){s.lines.forEach(t=>{const e=s.layouts.get(t.id),a=document.querySelector(`.line-card[data-line-id="${t.id}"]`);if(!a)return;a.querySelectorAll(".station-group").forEach(n=>{n.addEventListener("click",()=>{const o=n.dataset.stopId,r=e.stations.find(l=>l.id===o);r&&re(r)})})})}function b(){const t=J();if(qt.textContent=s.theme==="dark"?"Light":"Dark",Oe.textContent=t.kicker,Pe.textContent=t.title,St.hidden=s.systemsById.size<2,St.innerHTML=pa(),ce(),Pt.forEach(e=>e.classList.toggle("is-active",e.dataset.tab===s.activeTab)),document.querySelector("#tab-trains").textContent=v(),Ra(),s.activeTab==="map"){w.className="board";const e=s.compactLayout?s.lines.filter(a=>a.id===s.activeLineId):s.lines;w.innerHTML=`${V()}${e.map(Ea).join("")}`,j(),Rt(),Pa(),queueMicrotask(q);return}if(s.activeTab==="trains"){w.className="board",w.innerHTML=`${V()}${Ca()}`,j(),Rt(),Oa(),queueMicrotask(q);return}s.activeTab==="insights"&&(w.className="board",w.innerHTML=`${V()}${ka()}`,j())}function qa(){window.clearInterval(s.insightsTickerTimer),s.insightsTickerTimer=0}function Ba(){qa(),s.insightsTickerTimer=window.setInterval(()=>{s.insightsTickerIndex+=1,s.activeTab==="insights"&&b()},5e3)}function ce(){R.textContent=s.error?"HOLD":"SYNC",R.classList.toggle("status-pill-error",!!s.error),qe.textContent=`Now ${Qe()}`,Y.textContent=s.error?"Using last successful snapshot":Je(s.fetchedAt),wt.textContent=R.textContent,wt.classList.toggle("status-pill-error",!!s.error),_e.textContent=Y.textContent}function _a(){window.clearTimeout(s.liveRefreshTimer),s.liveRefreshTimer=0}function Ua(){_a();const t=()=>{s.liveRefreshTimer=window.setTimeout(async()=>{await dt(),t()},Ee)};t()}function de(t){const e=s.systemsById.has(t)?t:D,a=s.systemsById.get(e);s.activeSystemId=e,s.lines=a?.lines??[],s.layouts=s.layoutsBySystem.get(e)??new Map,s.lines.some(i=>i.id===s.activeLineId)||(s.activeLineId=s.lines[0]?.id??""),s.vehiclesByLine=new Map,s.rawVehicles=[],s.arrivalsCache.clear(),s.alerts=[],s.error="",s.fetchedAt="",s.insightsTickerIndex=0}async function ue(t,{updateUrl:e=!0,preserveDialog:a=!1}={}){if(!s.systemsById.has(t)||s.activeSystemId===t){e&&Ct(s.activeSystemId);return}de(t),a||ae(),lt(),ct(),b(),e&&Ct(t),await dt()}async function Ha(){const a=(await(await fetch(Ie,{cache:"no-store"})).json()).systems??[];s.systemsById=new Map(a.map(i=>[i.id,i])),s.layoutsBySystem=new Map(a.map(i=>[i.id,new Map(i.lines.map(n=>[n.id,sa(n)]))])),de(ee())}function Fa(t){const e=[...new Set((t.allAffects??[]).map(i=>i.routeId).filter(Boolean))],a=s.lines.filter(i=>e.includes(ie(i))).map(i=>i.id);return a.length?{id:t.id,effect:t.reason??"SERVICE ALERT",severity:t.severity??"INFO",title:t.summary?.value??"Service alert",description:t.description?.value??"",url:t.url?.value??"",lineIds:a,stopIds:[...new Set((t.allAffects??[]).map(i=>i.stopId).filter(Boolean))]}:null}async function dt(){try{const t=await jt(ze(),"Realtime");s.error="",s.fetchedAt=new Date().toISOString(),s.rawVehicles=t.data.list??[],s.alerts=(t.data.references?.situations??[]).map(Fa).filter(Boolean);const e=new Map((t.data.references?.trips??[]).map(a=>[a.id,a]));for(const a of s.lines){const i=s.layouts.get(a.id),n=s.rawVehicles.map(o=>ua(o,a,i,e)).filter(Boolean);s.vehiclesByLine.set(a.id,n)}}catch(t){s.error="Realtime offline",console.error(t)}b()}async function Va(){_t(Ze()),At(),await Ha(),b(),await dt(),await kt(),window.addEventListener("popstate",()=>{kt().catch(console.error)});const t=()=>{const a=s.compactLayout;if(At(),a!==s.compactLayout){b();return}q()};window.addEventListener("resize",t),window.visualViewport?.addEventListener("resize",t),new ResizeObserver(()=>{q()}).observe(w),Ua(),Ba(),window.setInterval(()=>{ce(),$a(),da()},1e3)}Va().catch(t=>{R.textContent="FAIL",Y.textContent=t.message});
